"""
Django settings for pdfFiles project.
...
SECRET_KEY = 'django-insecure-jy+u4-i#0-!=uyjz0m3id$!0j(7qcc2lr^flcu6&q_sxdkl2xk'
...
WSGI_APPLICATION = 'pdfFiles.wsgi.application'
